...
export const argTab = (
  ...
  // 8) if input is 'projects go '
    ...
    [
      "1.Car Intelligent Cockpit Banma AliOS",
      "2.AI-Hybrid Service Desk",
      "3.Warehouse Video Intelligent Inspection Solution",
      "4.In-Vehicle Citylife Service Cloud Application",
    ].forEach(t => {
      hintsCmds = [...hintsCmds, t];
    });
    return hintsCmds;
